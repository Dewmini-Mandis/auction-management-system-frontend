...
const Footer = () => {
  ...
  <div className="flex space-x-2">
    <a href="https://www.visa.com" target="_blank" rel="noopener noreferrer">
      <img src={Visa} alt="Visa" className="w-8 h-8 cursor-pointer" />
    </a>
    <a href="https://www.mastercard.com" target="_blank" rel="noopener noreferrer">
      <img src={Mastercard} alt="Mastercard" className="w-8 h-8 cursor-pointer" />
    </a>
    <a href="https://google.com" target="_blank" rel="noopener noreferrer">
      <img src={Google} alt="Google" className="w-8 h-8 cursor-pointer" />
    </a>
    <a href="https://www.paypal.com" target="_blank" rel="noopener noreferrer">
      <img src={PayPal} alt="PayPal" className="w-8 h-8 cursor-pointer" />
    </a>
  </div>
</div>
        ...
        <img src={Facebook} alt="Facebook" className="inline-block mr-2"/> Facebook
      </a>
    </li>
    <li>
      <a href="https://www.twitter.com" className="hover:underline">
        <img src={TwitterSquared} alt="Twitter" className="inline-block mr-2"/> Twitter
      </a></li>
          </ul>
        </div>
